...
export default function page() {
  return (
    <div className="p-12 border rounded-3xl">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to auracv.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to auracv, accessible from{" "}
            <a
              href="https://www.auracv.me"
      ...
      <ul>
        <li>By email: robinkphilip2001@gmail.com</li>
      </ul>
    </div>
  );
}
