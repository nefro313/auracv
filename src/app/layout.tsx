...
export default function RootLayout({
  ...
  const fontVariables = ` ${robotoFont.variable} ${soraFont.variable} ${urbanistFont.variable} ${DM_SansFont.variable} ${ManropeFont.variable} ${OutfitFont.variable} ${QuattrocentoFont.variable} ${FrauncesFont.variable}`;
  return (
